...
|`&beard=2212&brow=1555&cheek_details=1356&ear=1423&eye=1614&eyelash=-1`<br />`&eye_details=1352&face_lines=1366`<br />`&glasses=2465&hair=1723&hat=2495&jaw=1400`<br />`&mouth=2338&nose=1482&beard_tone=8678208`<br />`&blush_tone=16754088&brow_tone=6772090`<br />`&eyeshadow_tone=-1&hair_tone=8637550`<br />`&hair_treatment_tone=10513945&lipstick_tone=16740668`<br />`&pupil_tone=5793385&skin_tone=9657655&body=1`<br />`&face_proportion=13&eye_spacing=0&eye_size=2` | This is where all gender specific traits are injected into the URL. Not all traits are required to render, and every trait has a specific set of values that work with it. For any trait that has `tone` in its name, its value is actually just a color in decimal form. |
